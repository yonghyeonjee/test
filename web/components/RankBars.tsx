          ...
          return (
            <g key={b.label}>
              ...
              <text x={LABEL - 8} y={y + H / 2 + 4.5} textAnchor="end" fontSize="12.5"
                    fill="#2E3A3C" fontFamily="inherit">{b.label}</text>
              <rect x={LABEL} y={y + 5} width={plotW} height={H - 10} fill="#F2F4F5" rx="4" />
              <path d={path} fill="#0D6B4F" />
              <text x={LABEL + w + 6} y={y + H / 2 + 4.5} fontSize="12" fill="#647175"
